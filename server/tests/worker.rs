...
use utils::{
    ...
    get_default_test_config, run_with_retries, start_server, start_server_with_cfg,
};
...
async fn test_endpoint_disable_on_repeated_failure() {
    ...
    if !matches!(cfg.cache_type, web3hook_server::cfg::CacheType::None) {
