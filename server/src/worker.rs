...
fn generate_msg_headers(
    ...
    headers.insert("web3hook-id".to_owned(), id_hdr);
    headers.insert("web3hook-timestamp".to_owned(), timestamp);
    headers.insert("web3hook-signature".to_owned(), signatures_str);
