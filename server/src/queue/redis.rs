...
const MAIN: &str = "{queue}_w3h_v3_main";
...
const DELAYED: &str = "{queue}_w3h_delayed";

/// The key for the lock guarding the delayed queue background task.
const DELAYED_LOCK: &str = "{queue}_w3h_delayed_lock";

// v2 KEY CONSTANTS
const LEGACY_V2_MAIN: &str = "{queue}_w3h_main";
const LEGACY_V2_PROCESSING: &str = "{queue}_w3h_processing";
...
pub mod tests {
    ...
    async fn test_migrate_list() {
        ...
        const TEST_QUEUE: &str = "{queue}_w3h_test_queue_list";
    ...
    async fn test_migrate_sset() {
        ...
        const TEST_QUEUE: &str = "{queue}_w3h_test_queue_sset";
